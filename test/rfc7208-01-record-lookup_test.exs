defmodule Rfc7208.Section1Test do
  ...
  test "1.0 alltimeout" do
    ...
    ctx = Spf.check("foo@alltimeout.example.net", helo: "mail.example.net", ip: "1.2.3.4", dns: "test/zones/rfc7208-01-record-lookup.zonedata")
  ...
  test "1.1 both" do
    ...
    ctx = Spf.check("foo@both.example.net", helo: "mail.example.net", ip: "1.2.3.4", dns: "test/zones/rfc7208-01-record-lookup.zonedata")
  ...
  test "1.2 nospftxttimeout" do
    ...
    ctx = Spf.check("foo@nospftxttimeout.example.net", helo: "mail.example.net", ip: "1.2.3.4", dns: "test/zones/rfc7208-01-record-lookup.zonedata")
  ...
  test "1.3 spfonly" do
    ...
    ctx = Spf.check("foo@spfonly.example.net", helo: "mail.example.net", ip: "1.2.3.4", dns: "test/zones/rfc7208-01-record-lookup.zonedata")
  ...
  test "1.4 spftimeout" do
    ...
    ctx = Spf.check("foo@spftimeout.example.net", helo: "mail.example.net", ip: "1.2.3.4", dns: "test/zones/rfc7208-01-record-lookup.zonedata")
  ...
  test "1.5 txtonly" do
    ...
    ctx = Spf.check("foo@txtonly.example.net", helo: "mail.example.net", ip: "1.2.3.4", dns: "test/zones/rfc7208-01-record-lookup.zonedata")
  ...
  test "1.6 txttimeout" do
    ...
    ctx = Spf.check("foo@txttimeout.example.net", helo: "mail.example.net", ip: "1.2.3.4", dns: "test/zones/rfc7208-01-record-lookup.zonedata")
