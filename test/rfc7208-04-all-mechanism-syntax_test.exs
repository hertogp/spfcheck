defmodule Rfc7208.Section4Test do
  ...
  test "4.0 all-arg" do
    ...
    #
    ctx = Spf.check("foo@e2.example.com", helo: "mail.example.com", ip: "1.2.3.4", dns: "test/zones/rfc7208-04-all-mechanism-syntax.zonedata")
  ...
  test "4.1 all-cidr" do
    ...
    #
    ctx = Spf.check("foo@e3.example.com", helo: "mail.example.com", ip: "1.2.3.4", dns: "test/zones/rfc7208-04-all-mechanism-syntax.zonedata")
  ...
  test "4.2 all-dot" do
    ...
    #
    ctx = Spf.check("foo@e1.example.com", helo: "mail.example.com", ip: "1.2.3.4", dns: "test/zones/rfc7208-04-all-mechanism-syntax.zonedata")
  ...
  test "4.3 all-double" do
    ...
    #
    ctx = Spf.check("foo@e5.example.com", helo: "mail.example.com", ip: "1.2.3.4", dns: "test/zones/rfc7208-04-all-mechanism-syntax.zonedata")
  ...
  test "4.4 all-neutral" do
    ...
    #
    ctx = Spf.check("foo@e4.example.com", helo: "mail.example.com", ip: "1.2.3.4", dns: "test/zones/rfc7208-04-all-mechanism-syntax.zonedata")
